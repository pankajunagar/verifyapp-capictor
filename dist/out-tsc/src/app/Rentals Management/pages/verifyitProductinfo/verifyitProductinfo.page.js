...
var VerifyitProductInfoPage = /** @class */ (function () {
    function VerifyitProductInfoPage(nfc, ndef, autocloseOverlaysService, navCtrl, platform, iab, ngZone, socialSharing, qrScanner, utilservice, alertService, toastController, router, sanitizer, alertController, apiSvc, modalController, actionSheetController) {
        var _this_1 = this;
        this.nfc = nfc;
        this.ndef = ndef;
    ...
    VerifyitProductInfoPage.prototype.ngOnInit = function () {
    ...
    VerifyitProductInfoPage.prototype.showProductVideo = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var res;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage.prototype.ionViewDidLeave = function () {
        // this.navCtrl.pop();
    };
    // scanqrcode() {
    //   var context = this;
    ...
    VerifyitProductInfoPage.prototype.trackingLinks = function (data) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this_1 = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    VerifyitProductInfoPage.prototype.presentToast = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var toast;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage.prototype.openInappBrowser = function (element) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage.prototype._addListenersToPlayerPlugin = function () {
        var _this_1 = this;
    ...
    // tracking apis
    VerifyitProductInfoPage.prototype.shareTracking = function () {
    ...
    VerifyitProductInfoPage.prototype.trackingReview = function (data) {
        var _this_1 = this;
        var _this = this;
    ...
    VerifyitProductInfoPage.prototype.trackingOnlinePurchase = function (element) {
        // this.shortToken= window.localStorage.getItem('token')
    ...
    VerifyitProductInfoPage.prototype.openQuiz = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage.prototype.trackingVideoCompletion = function (data) {
        var shareData = {
            user_id: window.localStorage.getItem("userid"),
            tag_id: window.localStorage.getItem("tagId"),
            product_id: this.callgettagresult.product_id,
    ...
    VerifyitProductInfoPage.prototype.openUserModal = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage.prototype.hardwareBackbutton = function () {
        var _this_1 = this;
        this.platform.backButton.subscribeWithPriority(10, function () {
            ...
            //   console.log('Event jeepCapVideoPlayerExit ', data)
            // }, false);
            _this_1.autocloseOverlaysService.trigger();
        });
    };
    VerifyitProductInfoPage.prototype.generateEwarrantyCard = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    VerifyitProductInfoPage = tslib_1.__decorate([
        Component({
...
export { VerifyitProductInfoPage };
//# sourceMappingURL=verifyitProductinfo.page.js.map