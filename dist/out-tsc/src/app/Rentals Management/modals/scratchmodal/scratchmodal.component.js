...
var ScratchmodalComponent = /** @class */ (function () {
    function ScratchmodalComponent(modalController, utils, loadingCtrl, noticeService, router, alertCtrl, alertService, route, webView, transService, actionSheet) {
    ...
    ScratchmodalComponent.prototype.ngOnInit = function () {
    ...
    ScratchmodalComponent.prototype.presentLoading = function () {
    ...
    ScratchmodalComponent.prototype.closeModal = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    ScratchmodalComponent.prototype.redeemNow = function () {
        // alert('Coming soon.')
        this.presentAlertConfirm();
        // this.alertService.presentAlert('Coming soon','Login to secure your loyalty point.')
    };
    ScratchmodalComponent.prototype.presentAlertConfirm = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    ScratchmodalComponent.prototype.LoginNow = function () {
        this.modalController.dismiss();
        this.router.navigateByUrl('/login');
    };
    ScratchmodalComponent.prototype.createNewScratchCard = function () {
    ...
    ScratchmodalComponent = tslib_1.__decorate([
        Component({
    ...
    return ScratchmodalComponent;
}());
export { ScratchmodalComponent };
//# sourceMappingURL=scratchmodal.component.js.map