...
var HomePage = /** @class */ (function () {
    function HomePage(ticketService, loadingCtrl, router, modalController, 
    // private barcodeScanner: BarcodeScanner,
    userService, alertService, push, transService, storage, device, alertCtrl, _navCtrl) {
        var _this = this;
        ...
        this.pushObject.on('notification').subscribe(function (notification) {
            ...
            if (notification.additionalData.type == 'discussion') {
                ...
                if (notification.additionalData.id) {
                    ...
                    _this._navCtrl.navigateForward("/building-management-notice-details", {
                        queryParams: {
                    ...
                    _this._navCtrl.navigateForward("/building-management-notice-board");
                }
            }
            else if (notification.additionalData.type == 'ticket') {
                _this.presentAlert(notification.title);
                if (notification.additionalData.id) {
                    _this._navCtrl.navigateForward("/building-management-ticket-details", {
                        queryParams: {
                    ...
                    _this._navCtrl.navigateForward('/building-management-tickets');
                }
            }
            ...
            return tslib_1.__generator(this, function (_a) {
                this.ticketService.getTicketStats()
                    ...
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                if (!(this.loading == true)) return [3 /*break*/, 2];
