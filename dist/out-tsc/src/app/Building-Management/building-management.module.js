...
var BuildingManagementModule = /** @class */ (function () {
    function BuildingManagementModule() {
    }
    BuildingManagementModule = tslib_1.__decorate([
        NgModule({
            declarations: [
    ...
    return BuildingManagementModule;
}());
export { BuildingManagementModule };
//# sourceMappingURL=building-management.module.js.map