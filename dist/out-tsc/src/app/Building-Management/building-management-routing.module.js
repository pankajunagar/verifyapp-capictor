...
var BuildingManagementRoutingModule = /** @class */ (function () {
    function BuildingManagementRoutingModule() {
    }
    BuildingManagementRoutingModule = tslib_1.__decorate([
        NgModule({
            imports: [
    ...
    return BuildingManagementRoutingModule;
}());
export { BuildingManagementRoutingModule };
//# sourceMappingURL=building-management-routing.module.js.map